...
public class OpCom {
	...
	private PlotterPanel setpointPlotter;
	...
	private JPanel innerParLabelPanel, innerParFieldPanel, outerParLabelPanel, outerParFieldPanel, rightPanel;
	...
	public OpCom() {
		...
		setpointPlotter = new PlotterPanel(1,4);
	}
	...
	public void initializeGUI() {
		...
		measurementPlotter.setTitle("Measured variable");
		measurementPlotter.setBackground(Color.BLACK);
		plotterPanel.add(measurementPlotter);
		plotterPanel.addFixed(10);
		setpointPlotter.setYAxis(2, -1, 2, 2);
		setpointPlotter.setXAxis(range, divTicks, divGrid);
		setpointPlotter.setTitle("Set-point");
		setpointPlotter.setBackground(Color.BLACK);
		plotterPanel.add(setpointPlotter);
		plotterPanel.addFixed(10);
		controlPlotter.setYAxis(2, -1, 2, 2);
		controlPlotter.setXAxis(range, divTicks, divGrid);
		controlPlotter.setTitle("Control");
		controlPlotter.setBackground(Color.BLACK);
		...
		rightPanel.add(innerParButtonPanel, BorderLayout.WEST);
		rightPanel.add(outerParButtonPanel, BorderLayout.EAST);
		...
		JLabel topText = new JLabel("Ball and Beam GUI");
		topText.setFont(new Font("Courier New", Font.BOLD, 20));
	...
	public synchronized void putMeasurementDataPoint(PlotData pd) {
		...
		double ref = pd.ref;
		double y = pd.y;
		setpointPlotter.putData(x, ref);
		measurementPlotter.putData(x, y);
	}
}